    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if (currentItem.getProfession().equals("Knight")) {
            if (currentItem.getWeaponType().equals("basic")) {
                itemIV.setImageResource(R.drawable.basic_sword_holding);
            }
        ...
        //MAGE
            ...
            if (currentItem.getWeaponType().equals("basic")) {
                itemIV.setImageResource(R.drawable.basic_staff_holding);
            }
            if (currentItem.getWeaponType().equals("fancy")) {
        ...
        //RANGER
            ...
            if (currentItem.getWeaponType().equals("basic")) {
                itemIV.setImageResource(R.drawable.basic_bow_holding);
            }
            if (currentItem.getWeaponType().equals("fancy")) {
